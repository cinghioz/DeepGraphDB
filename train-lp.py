...
x = torch.load("/home/cc/PHD/dglframework/DeepKG/start_feats.pt", weights_only=False)
...
model = AdvancedHeteroLinkPredictor(
    ...
    gnn_type='rgated',  # Use 'sage', 'rgcn', or 'rgated' as needed
    scores = None
)
...
vdb = ChromaFramework(persist_directory="./ChromaVDB/chroma_db_latest")
